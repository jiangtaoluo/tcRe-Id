...
_C.DATASETS.DATA_PATH = '/mnt/storage/Dataset/VeRi/VeRi/'
# PATH to train set
_C.DATASETS.TRAIN_PATH = 'image_train'
# PATH to query set
_C.DATASETS.QUERY_PATH = 'image_query'
# PATH to gallery set
_C.DATASETS.GALLERY_PATH = 'image_test'
